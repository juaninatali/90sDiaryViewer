...
export const diaryEntries: DiaryEntry[] = [
  {
      ...
      tags: ["Event: Megabit en Plaza", "Artist: Megabit", "Genre: Techno Pop"],
...
También me dijo que lo que mas escuchaba últimamente era Nine Inch Nails y Skinny Puppy.`,
      images: ["/images/TheFirstReport_037a.png"]
    },
    {
      id: "entry-002",
      date: "1995-05-12",
      ...
      tags: ["Venue: Fellini.", "Genre: Hard Trance", "Genre: Hard Trance"],
...
Fellini es Techno y voy a volver muchas veces.`,
      images: ["/images/TheFirstReport_038a.png"]
    }
  ];